...
class RootControllerTest {
    ...
    void givenInvalidLength_whenExecSearch_thenFailure() throws Exception {
        this.mockMvc.perform(post("/search")
                ...
                .andExpect(view().name("search"))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Failed to convert property value of type java.lang.String to required type java.lang.Integer for property length; nested exception is java.lang.NumberFormatException: For input string:")));
    }
